...
import RightForgotPasswordSectionSkeleton from './RightForgotPasswordSectionSkeleton';

// Dynamically import the main form component
const DynamicRightForgotPasswordSection = dynamic(() => import('./RightForgotPasswordSection'), {
  ...
  return (
    <div className="min-h-screen w-screen flex font-sans">
      ...
      <div className="w-full md:w-2/5 bg-[#E0E4F3] flex items-center justify-center p-6 sm:p-8 md:p-12 lg:p-16 min-h-screen">
        <Suspense fallback={<RightForgotPasswordSectionSkeleton />}>
            <DynamicRightForgotPasswordSection />
        </Suspense>
      </div>
    </div>
  );
